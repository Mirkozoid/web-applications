...
namespace Telegram_Bot
{
    class SendMessage
    {
        ...
        {
            await Program.BotClient.SendTextMessageAsync(chatId: Program.Messages.Chat.Id, text: News.textNews[Variables.RandomIndexNew()], 
        ...
        public async static void NewsEveryDay()
        {
            for (int i = 0; i < User.users.Count; i++)
            {
               ...
               text: News.textNews[Variables.RandomIndexNew()], cancellationToken: new CancellationToken());    
            }
        }
